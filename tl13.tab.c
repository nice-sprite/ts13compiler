...
static const char *const yytname[] =
{
  ...
  "NUMBER", "BOOLLIT", "IDENT", "LP", "RP", "ASGN", "SC", "OP2", "OP3",
  "OP4", "IF", "THEN", "ELSE", "MYBEGIN", "END", "WHILE", "DO", "PROGRAM",
  "VAR", "AS", "WRITEINT", "READINT", "$accept", "program", "declarations",
...
{
     -11,   -10,    20,    17,     7,   -30,     3,    -3,    15,    18,
       1,     1,     1,    10,    21,   -30,   -30,   -30,   -30,   -30,
     -30,    22,    -5,   -30,   -30,   -30,     1,    19,    23,    25,
      24,    13,   -30,   -30,    -3,   -10,   -30,   -30,    30,    -3,
       1,     1,     1,    -3,   -30,   -30,   -30,    14,   -30,   -30,
     -30,    26,    -3,    27,   -30,   -30,   -30
};
...
{
       2,     4,     0,     0,     0,     1,     0,     8,     0,     0,
       0,     0,     0,     0,     0,    10,    11,    12,    13,     6,
       7,     0,     0,    28,    29,    27,     0,     0,    21,    24,
      26,     0,    20,     3,     8,     4,    15,    14,     0,     8,
       0,     0,     0,     8,     9,     5,    30,    17,    22,    23,
      25,     0,     8,     0,    19,    18,    16
};
...
{
      23,    24,    25,    26,     9,    44,    23,    24,    25,    26,
      47,     1,    10,     3,    51,    31,    32,    11,    19,    20,
       5,    36,    12,    55,     6,     7,    37,     8,    22,    33,
      38,    52,    34,    35,    43,    39,    42,    40,    41,    46,
      45,    49,    48,     0,     0,    54,    56,     0,    50
};

static const yytype_int8 yycheck[] =
{
       5,     6,     7,     8,     7,    34,     5,     6,     7,     8,
      39,    22,    15,    23,    43,    11,    12,    20,     3,     4,
       0,    26,    25,    52,     7,    18,    22,    24,    10,    19,
      26,    17,    11,    11,    21,    16,    12,    14,    13,     9,
      35,    41,    40,    -1,    -1,    19,    19,    -1,    42
};
...
{
       0,    22,    28,    23,    29,     0,     7,    18,    24,     7,
      15,    20,    25,    31,    32,    33,    34,    36,    37,     3,
       4,    30,    10,     5,     6,     7,     8,    38,    39,    40,
      41,    38,    38,    19,    11,    11,    26,    38,    38,    16,
      14,    13,    12,    21,    31,    29,     9,    31,    39,    40,
